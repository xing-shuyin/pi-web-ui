...
const zh = {
	...
	settingsMarkersDesc:
		"让 AI 用 [[todo:...]] / [[svc:...]] / [[notify:...]] / [[conv:rename:...]] 内联标记在正文里改状态，无需工具往返。全局关闭则全部停用；分组开关可细粒度控制。",
	...
	markerGroupSvc: "后台服务标记 svc",
	markerGroupNotify: "提醒标记 notify",
	markerGroupRename: "重命名标记 conv/rename",
	markerRenameTip: "[[conv:rename:新标题]] 或 [[rename:set:标题]] 重命名当前对话（标题 ≤80 字）",
...
const en: Record<keyof typeof zh, string> = {
	...
	settingsMarkersDesc:
		"Let the AI write [[todo:...]] / [[svc:...]] / [[notify:...]] / [[conv:rename:...]] inline markers in replies to update state without a tool round-trip. Global off disables all; per-marker toggles give fine control.",
	...
	markerGroupSvc: "svc — background services",
	markerGroupNotify: "notify — non-blocking hints",
	markerGroupRename: "conv/rename — rename chat",
	markerRenameTip: "[[conv:rename:Title]] or [[rename:set:Title]] renames the current conversation (≤80 chars)",
